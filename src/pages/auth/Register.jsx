...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("buybuddy_user", JSON.stringify(res.data));
      navigate("/dashboard");
    } catch (err) {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 bg-white p-6 rounded shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <input name="name" placeholder="Name" onChange={handleChange} required className="w-full px-4 py-2 border rounded" />
